...
namespace Engine {
	namespace Renderer {
		...
		void OBJModel::loadModel(string const & path)
		{
		...
		inline Mesh OBJModel::processMesh(aiMesh * mesh, const aiScene * scene)
		{
			// data to fill
		...
		inline vector<Mesh::Texture> OBJModel::loadMaterialTextures(aiMaterial * mat, aiTextureType type, string typeName)
		{
			vector<Mesh::Texture> textures;
